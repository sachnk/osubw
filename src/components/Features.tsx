...
const features = [
  ...
  },
  {
    ...
    description:
      "Time is just another event. Our fully abstracted clock enables deterministic replay of every tick, so any change can be verified by replaying the exact sequence of events with bit-perfect fidelity. Ship with total confidence.",
    metric: "100%",
    metricLabel: "Determinism",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {features.map((feature, i) => (
            ...
            >
              <div
                className={`glass-card p-8 group hover:glow-accent transition-all duration-500 h-full ${
                  i === features.length - 1 && features.length % 2 !== 0
